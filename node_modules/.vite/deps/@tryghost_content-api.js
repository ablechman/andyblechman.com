...
function GhostContentAPI(_ref2) {
  ...
  function makeApiRequest(resourceType, params, id) {
    ...
    const apiUrl = `${url}/${ghostPath}/api${resolveAPIPrefix(version2)}${resourceType}/${id ? id + "/" : ""}`;
    return makeRequest({
      url: apiUrl,
      method: "get",
      params,
